...
define("appmsg/channel/channels.js",["biz_common/tmpl.js","biz_common/dom/event.js","biz_wap/jsapi/core.js","appmsg/appmsg_card.js","appmsg/channel/video_snap_tpl.html.js","biz_wap/utils/ajax.js","biz_wap/utils/mmversion.js","biz_wap/utils/device.js","pages/utils.js","common/utils.js","common/comm_report.js"],function(e,n,t,i){
"use strict";
function o(e){
if(!y.isWechat||A.os.pc||y.is_wxwork)return!1;
if(y.isIOS&&y.ltVersion("7.0.15",!1))return!1;
if(y.isAndroid&&window.clientversion<="27001337")return!1;
if(y.isAndroid&&window.clientversion>"2700135F"&&window.clientversion<"27001400")return!1;
if(9===e){
if(y.isAndroid&&window.clientversion<"27001438")return!1;
if(y.isIOS&&window.clientversion<"17001227")return!1;
}
return!0;
}
function a(e,n,t){
...
if(a(3,e,t),9===r)return void((y.isAndroid&&window.clientversion<"27001438"||y.isIOS&&window.clientversion<"17001227")&&window.weui.alert("请升级微信客户端版本后查看"));
if(y.isAndroid&&window.clientversion>"2700135F"&&window.clientversion<"27001400")return void window.weui.alert("当前版本暂不支持查看");
y.isWechat&&A.os.pc?window.weui.alert("当前版本暂不支持查看，请在手机上查看"):(!y.isWechat||y.is_wxwork)&&i("请在微信内打开"),
!y.isWechat||A.os.pc||y.is_wxwork||I.jumpUrl("https://support.weixin.qq.com/update/",!0);
}
}
function s(e){
...
var n=e.parentNode;
if(n){
var t=n.getAttribute("data-id"),i=s(t),o=void 0;
i&&i.length>0&&(o=i[0]);
var a=o&&o.nonce_id?o.nonce_id:n.getAttribute("data-nonceid"),d=o&&o.flag||0,c=o&&o.username?o.username:n.getAttribute("data-username"),p=o&&o.media_type?o.media_type:n.getAttribute("data-mediatype");
0===d&&r(t,a,c,p);
}
}
function c(){
for(var e=document.getElementsByClassName("js_wechannel_img_card"),n=function(n){
var t=e[n];
v.on(t,"tap",function(){
d(t);
}),h.addAppmsgCardTouchEvent(t);
},t=0;t<e.length;t++)n(t);
}
function p(){
for(var e=document.getElementsByClassName("js_wechannel_video_card"),n=function(n){
var t=e[n];
v.on(t,"tap",function(){
d(t);
}),h.addAppmsgCardTouchEvent(t);
...
var n=C[e],t=n.firstChild;
if(t&&t.getBoundingClientRect().top>0&&t.getBoundingClientRect().top+t.getBoundingClientRect().height/2<=x.getInnerHeight()){
var i=n.getAttribute("data-id"),o=n.getAttribute("data-username");
-1===k.indexOf(i)&&(k.push(i),a(1,i,o));
}
}
}
function m(){
...
var t=C[n],i=t.getAttribute("data-id")||"",o=s(i),a=o.length>0?o[0]:{},r=void 0,d=4===a.media_type||9===a.media_type?"video":"image";
r={
snapType:a&&a.media_type?d:t.getAttribute("data-type"),
url:a.feed_cover_url||a.feed_thumb_url||t.getAttribute("data-url")||"",
headImgUrl:a.head_url||t.getAttribute("data-headimgurl")||"",
nickname:a.nickname||t.getAttribute("data-nickname")||"",
desc:a.feed_desc||t.getAttribute("data-desc")||"",
flag:a.flag||0
},"image"===r.snapType&&(r=_extends(r,{
imgCount:parseInt(a.media_num||"0",10)||parseInt(t.getAttribute("data-imgcount")||"0",10)||0
}));
var c=document.createElement("div");
c.innerHTML=g.tmpl(b,r),c.firstElementChild&&t.appendChild(c.firstElementChild);
var p=document.querySelector('[data-preloadingid="'+i+'"]');
p&&t.parentNode.removeChild(p);
}
u(),m();
}
}
...
},i={},o=0;o<t.video_snap_num;o++){
var a=e[o].export_id,r=e[o].username;
i[a]?i[a].push(o):(i[a]=[o],t["exportid_"+o]=a,t["username_"+o]=r);
}
var s="/mp/appmsg_video_snap?action=batch_get_video_snap";
for(var d in t)Object.prototype.hasOwnProperty.call(t,d)&&(s+="&"+d+"="+encodeURIComponent(t[d]));
j({
url:s,
type:"GET",
dataType:"json",
...
var g=e("biz_common/tmpl.js"),v=e("biz_common/dom/event.js"),f=e("biz_wap/jsapi/core.js"),h=e("appmsg/appmsg_card.js"),b=e("appmsg/channel/video_snap_tpl.html.js"),j=e("biz_wap/utils/ajax.js"),y=e("biz_wap/utils/mmversion.js"),A=e("biz_wap/utils/device.js"),I=e("pages/utils.js"),x=e("common/utils.js"),z=e("common/comm_report.js"),C=[],E=[],k=[];
_();
});var _extends=Object.assign||function(e){
for(var n=1;n<arguments.length;n++){
var t=arguments[n];
...
n.innerHTML=z.tmpl(B,e,!1),s.replyListHtml+=n.innerHTML,s.replyList.appendChild(n.firstChild);
})),s;
}
function d(e,n){
...
o.innerHTML=z.tmpl(x,e,!1),s.answerListHtml+=o.innerHTML,s.fragment.appendChild(o.firstChild);
...
function p(e,t,a){
var o=e.dataset.answerid,i=a?m(e,V.getScrollEle()):0;
S({
url:I.join("/mp/qna",_extends({
...
function f(){
E.on(X,"tap",".js_get_more_reply",function(e){
...
function y(){
g()?Y.enableBtn():Y.disableBtn();
}
function v(){
var e=w();
E.on(Z,"tap",".js_get_more_reply",function(e){
var n=e.delegatedTarget;
p(n,cn);
}),E.on(e,"input",y),E.on(e,"tap",function(){
Y.scrollTo(0,0);
});
}
function j(){
...
o&&s(o),i&&M.addClass(i,pn),n(X,"js_qa_qna_answer_list").innerHTML="",V=new O(X,{
title:"读者讨论",
extClass:"qa__card",
...
cb:function(s){
if(e&&t)u(t);else{
var o=K.dataset.count,i=n(X,"js_qa_list_item",o),r=m(i,V.getScrollEle());
V.scrollTo(0,r-96);
}
...
return Y?(b(),Y.setTitle(o),Y.setCloseBtnStyle(e?"back":"close"),Y.show(!0,un),void w().focus()):(Z=document.createElement("div"),
Z.innerHTML=z.tmpl(P,{}),Y=new O(Z,{
title:o,
top:un,
...
}),b(),Y.disableBtn(),Y.setCloseBtnStyle(e?"back":"close"),Y.show(!0,un),w().focus(),
v(),void new U.Emotion({
...
var t=void 0;
E.on(J,"tap",".js_get_more_reply",function(e){
var n=e.delegatedTarget,t=n.dataset.answerid;
wn[t]?T():(T(!0,t),wn[t]=!0);
}),E.on(document.body,"click",".js_qa_write_answer",function(e){
sn=!1,L(M.hasClass(e.delegatedTarget,pn)),o(2);
}),E.on(document.body,"click",".js_write_reply",function(e){
...
}),E.on(document.body,"tap",".js_qa_like",function(e){
var t=e.delegatedTarget,s=M.hasClass(t,mn);
M.toggleClass(t,mn);
...
}),E.on(document.body,"tap",".js_delete_answer",function(e){
var n=e.delegatedTarget;
...
}),E.on(document.body,"tap",".js_delete_reply",function(e){
...
return _?void(J.innerHTML=z.tmpl(k,{
qaDeleted:_
})):void(0===l&&("1"===I.getQuery("js_my_answer")&&(L(),o(4)),e&&e.answer_list&&e.answer_list.length&&(i=d(e.answer_list,!1).answerListHtml,
...
var S=e("biz_wap/utils/ajax.js"),E=e("biz_common/dom/event.js"),H=e("pages/utils.js"),z=e("biz_common/tmpl.js"),k=e("question_answer/qa_card.html.js"),x=e("question_answer/answer_item.html.js"),B=e("question_answer/reply_item.html.js"),P=e("question_answer/write_answer_reply.html.js"),I=e("biz_common/utils/url/parse.js"),M=e("biz_common/dom/class.js"),O=e("pages/mod/bottom_modal.js"),U=e("appmsg/emotion/emotion.js"),D=e("appmsg/emotion/dom.js"),R=e("common/comm_report.js"),A=e("biz_wap/utils/device.js"),F=e("common/utils.js"),W=e("biz_common/dom/offset.js"),Q=e("biz_wap/utils/wapsdk.js"),J=document.getElementsByTagName("mp-qa")[0];
if(!J)return{};
var G=void 0,K=void 0,V=void 0,X=void 0,Y=void 0,Z=void 0,$={},en=0,nn=0,tn=0,sn=void 0,an=void 0,on=void 0,rn=void 0,ln="",_n=10,dn="answerList",cn="myAnswerList",mn="praised",pn="modalWriteAnswerClass",un="25px",fn={
