...
var e=t.progressBarMark[a];
e.id===s.id&&t.progressBarMark.splice(a,1);
}
}
}
};
...
define("pages_new/common_share/video/lifecycle_manager.js",["biz_wap/utils/ajax.js","pages_new/modules/utils/url.js"],function(n){
"use strict";
function t(n){
"function"==typeof n&&c.push(n);
}
function e(n){
...
function r(n){
e(n.init),t(n.destroy),"function"==typeof n.init&&n.init(!0);
}
function s(n){
l||(l=!0,a({
type:"GET",
...
i();
var r=u.getParams(),s=_extends({},r,u.getParams(n)),a=u.genUrl("https://mp.weixin.qq.com/s",s);
history.replaceState(null,"",a),window.__initGlobalData(t,s),window.__initCgiDataConfig(t,s),
window.__initCommentConfig(t,s),o();
}
},
complete:function(){
l=!1;
...
var a=n("biz_wap/utils/ajax.js"),u=n("pages_new/modules/utils/url.js"),c=[],f=[],l=!1;
return{
register:r,
openNewVideo:s
};
