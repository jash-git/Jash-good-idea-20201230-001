...
define("pages_new/common_share/video/store.js",["pages_new/3rd/vue.js","pages_new/3rd/vuex.js","pages_new/modules/utils/url.js","pages_new/common_share/video/lifecycle_manager.js","pages_new/common_share/video/player/player_store.js","pages_new/common_share/video/related_video_list/related_video_list_store.js","pages_new/common_share/video/like_and_share/like_and_share_store.js","pages_new/common_share/video/topic/topic_store.js","pages_new/common_share/video/player/plugins/tail/tail_store.js","pages_new/common_share/video/player/plugins/danmu/danmu_store.js","pages_new/common_share/video/player/plugins/popup/popup_store.js","pages_new/common_share/video/player/plugins/mid_ad/mid_ad_store.js","pages_new/common_share/video/player/plugins/auto_next/auto_next_store.js"],function(e){
"use strict";
function n(){
...
function s(){
y.commit(d.SET_CGI_DATA,n()),y.commit(d.SET_URL_PARAMS,t.getParams()),w.forEach(function(e){
return y.registerModule(e.name,e);
}),R.forEach(function(e){
return y.registerModule([p.name,e.name],e);
});
}
function i(){
y.commit(d.SET_EXT_RES,{}),y.commit(d.SET_AD_RES,{}),y.commit(d.SET_CGI_DATA,{}),
y.commit(d.SET_URL_PARAMS,{}),w.forEach(function(e){
return y.unregisterModule(e.name);
}),R.forEach(function(e){
return y.unregisterModule([p.name,e.name]);
});
}
...
},p=e("pages_new/common_share/video/player/player_store.js"),m=e("pages_new/common_share/video/related_video_list/related_video_list_store.js"),c=e("pages_new/common_share/video/like_and_share/like_and_share_store.js"),u=e("pages_new/common_share/video/topic/topic_store.js"),w=[m,c,u],l=e("pages_new/common_share/video/player/plugins/tail/tail_store.js"),E=e("pages_new/common_share/video/player/plugins/danmu/danmu_store.js"),S=e("pages_new/common_share/video/player/plugins/popup/popup_store.js"),g=e("pages_new/common_share/video/player/plugins/mid_ad/mid_ad_store.js"),T=e("pages_new/common_share/video/player/plugins/auto_next/auto_next_store.js"),R=[l,E,S,g,T],y=new a.Store({
...
mutations:(_={},_defineProperty(_,d.SET_EXT_RES,function(e,n){
e.extRes=n;
}),_defineProperty(_,d.SET_AD_RES,function(e,n){
e.adRes=n;
}),_defineProperty(_,d.SET_CGI_DATA,function(e,n){
e.cgiData=n;
}),_defineProperty(_,d.SET_URL_PARAMS,function(e,n){
e.urlParams=n;
}),_defineProperty(_,d.SET_PRAISE_NUM,function(e,n){
e.extRes.appmsgstat&&e.extRes.appmsgstat.old_like_num&&(e.extRes.appmsgstat.old_like_num=n.praiseNum);
}),_defineProperty(_,d.SET_RECOMMEND_NUM,function(e,n){
e.extRes.appmsgstat&&e.extRes.appmsgstat.like_num&&(e.extRes.appmsgstat.like_num=n.recommendNum);
}),_defineProperty(_,d.SET_RECOMMEND_STATUS,function(e,n){
e.extRes.appmsgstat&&(e.extRes.appmsgstat.liked=n.hasRecommended?1:0);
}),_defineProperty(_,d.SET_PRAISE_STATUS,function(e,n){
e.extRes.appmsgstat&&(e.extRes.appmsgstat.old_liked=n.hasPraised?1:0);
}),_defineProperty(_,d.SET_SUBSCRIBE_STATUS,function(e,n){
e.extRes.is_fans=n.hasSubscribed?1:0;
}),_defineProperty(_,d.SET_PUBLIC_RELATED_VIDEO,function(e,n){
e.cgiData.isPublicRelatedVideo=n.isPublic?"1":"0";
}),_)
});
return r.register({
init:s,
...
var s=e("biz_wap/utils/ajax.js"),o=e("biz_common/dom/class.js"),n=e("biz_common/dom/event.js"),d=e("biz_common/utils/url/parse.js"),r=e("common/utils.js"),l=null;
...
o.hasClass(t,"js_reason")?u.delete(i):_.delete(i)):(o.addClass(t,"feedback_tag_selected"),
o.hasClass(t,"js_reason")?u.add(i):_.add(i)),0===u.size&&0===_.size?o.addClass(m,"weui-btn_disabled"):o.removeClass(m,"weui-btn_disabled");
...
this.container.querySelector(".js_feedback_dialog").style.display="",o.addClass(this.container.querySelector(".js_feedback_dialog"),"feedback_dialog_show");
...
n.off(e,"click",this.maskTouchMoveHandler,!1),o.removeClass(this.container.querySelector(".js_feedback_dialog"),"feedback_dialog_show");
},{
init:a
};
