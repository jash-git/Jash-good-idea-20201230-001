...
var Q=void 0,Y=null;
R(),h.on(window,"scroll",R),C(),h.on(window,"scroll",O),window.is_new_msg&&-1!=navigator.userAgent.indexOf("MicroMessenger")&&(window.title&&(window.title=window.title.replace(/&#39;/g,"'").replace(/&nbsp;/g," ").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&amp;/g,"&")),
...
if(St){
var Tt=xt[U].getBoundingClientRect();
Pt+=kt+"|"+Et+"|"+Tt.left.toFixed(2)+"|"+(kt-Tt.right).toFixed(2)+"|"+Tt.width.toFixed(2)+"|"+zt.toFixed(2)+"|"+St+";";
}
}
l({
...
e("appmsg/popup_report.js")),k=e("appmsg/pay_report_utils.js"),P=e("appmsg/loading.js"),z=-1,B=e("appmsg/finance_communicate.js"),S=e("appmsg/topbar.js"),T=e("biz_wap/utils/jsmonitor_report.js"),R=e("appmsg/getForbidConfig.js");
