...
});define("appmsg/set_article_read.js",["biz_wap/jsapi/core.js","common/utils.js","biz_common/dom/event.js"],function(e,o,n){
"use strict";
var t=e("biz_wap/jsapi/core.js"),i=e("common/utils.js"),s=e("biz_common/dom/event.js"),c=function(e){
t.invoke("handleMPPageAction",{
action:"syncReadState",
state:e
},function(e){
console.log("[set artile read]",e);
});
},a=function(){
var e=[0,10,8];
...
var e=function n(){
var e=document.documentElement.scrollTop||window.pageYOffset||document.body.scrollTop,t=o.offsetTop;
e+i.getInnerHeight()>t&&t>=e&&(c(1),s.off(window,"scroll",n));
};
e(),s.on(window,"scroll",e);
}();
}
};
n.exports={
setArticleRead:c,
bindArticleReadEvent:a
};
...
n.link=U(n.link,"scene",V[2]),o.url=n.link,o.actionType=2,r(t,o),T.invoke("shareTimeline",n);
}),T.on("menu:share:weiboApp",function(){
n.link=U(n.link,"scene",V[3]),o.url=n.link,o.actionType=3,r(t,o),T.invoke("shareWeiboApp",{
img_url:n.img_url,
link:n.link,
title:n.title
});
}),T.on("menu:share:facebook",function(){
n.link=U(n.link,"scene",V[4]),o.url=n.link,o.actionType=7,r(t,o),T.invoke("shareFB",n);
}),T.on("menu:share:QZone",function(){
n.link=U(n.link,"scene",V[5]),o.url=n.link,o.actionType=5,r(t,o),T.invoke("shareQZone",n);
}),T.on("menu:share:qq",function(){
n.link=U(n.link,"scene",V[6]),o.url=n.link,o.actionType=5,r(t,o),T.invoke("shareQQ",n);
}),T.on("menu:share:email",function(){
n.link=U(n.link,"scene",V[7]),o.url=n.link,o.actionType=5,r(t,o),T.invoke("sendEmail",{
content:n.link,
title:n.title
});
});
...
function l(e){
if("en"===window.LANG)return A.dealLikeReadShow_en(e);
var n="";
...
if(z.emojiDataMap[e]&&x[z.emojiDataMap[e].index]){
var n=x[z.emojiDataMap[e].index];
return z.emojiImg.replace("#name#",e).replace("#style#",n.style);
}
return e;
}):e;
},P=function(e,n){
z.inWechat?z.windowWechat||z.macWechat?n===!0?window.parent.open(e):window.parent.location.href=e:T.invoke("openUrlWithExtraWebview",{
url:e,
openType:1
},function(t){
...
!z.inWechat||z.windowWechat||z.macWechat?window.close():T.invoke("closeWindow",function(e){
...
var t=e.$container;
t&&!j.isInMiniProgram&&I.on(t,"tap",".js_go_profile",function(t){
...
var n=arguments.length<=1||void 0===arguments[1]?.5:arguments[1],t=arguments.length<=2||void 0===arguments[2]?"vertical":arguments[2],i=!1,o=0,r=0,a=!1,s=!1;
switch("number"==typeof n?(o=n,r=n):(o=n.vertical,r=n.horizontal),t){
case"vertical":
a=!0;
break;
...
if(a){
var l=c.height*o;
c.bottom>l&&c.top<F-l&&(i=!0);
}
if(!s)return i;
if(a&&!i)return i;
var u=c.width*r;
return i=c.right>u&&c.left<M-u?!0:!1;
},$=function(e){
